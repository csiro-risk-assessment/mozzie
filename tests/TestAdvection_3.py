...
class TestAdvection_3(unittest.TestCase):
   ...
   def testAdvect8(self):
      ...
      fn = os.path.join(findbin, "2D_advection_out_8_0.csv")
      spatial.outputCSV(fn, 0, "0", "")
      with open(fn) as f:
         data = f.readlines()
      ...
      fn = os.path.join(findbin, "2D_advection_out_8_1.csv")
      spatial.outputCSV(fn, 10, "0", "")
      with open(fn) as f:
         data = f.readlines()
      ...
      fn = os.path.join(findbin, "2D_advection_out_8_2.csv")
      spatial.outputCSV(fn, 4, "0", "")
      with open(fn) as f:
         data = f.readlines()
