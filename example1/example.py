...
# - advection by wind that is defined by 1 wind file only, and has exponentially-distributed 'drop off' timesx (1% of the population of each cell is advected)
...
for i in range(501):
   ...
   # advect 1% of the population at each cell
   spatial.advect(0.01, wind)
   if (i%100 == 0):
      sys.stdout.write("Outputting population result...\n")
      spatial.outputCSV("example_" + str(i) + "_days.csv", 0, "0", "")
