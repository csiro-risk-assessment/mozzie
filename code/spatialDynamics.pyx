...
cdef class SpatialDynamics:
    ...
    def void diffuse(self, float dt, float diffusion_coeff):
        ...
        def float diffusion_d = diffusion_coeff * num_nearest_neighbours * dt / (self.cell_size * self.cell_size)
        # diffusion_d / 4
        def float diff_d = diffusion_d / num_nearest_neighbours
    ...
    def advect(self, float [:] advection_fraction, Wind wind):
    ...
    def evolveCells(self, float timestep):
    ...
    def outputCSV(self, str filename, unsigned pop_or_param, str inactive_value, str additional_header_lines):
    ...
    def void diffuse_stoc(self, float dt, float diffusion_coeff):
    ...
    def advect_stoc(self, float advection_fraction, Wind wind):
