# Allows assessment of runtimes for Mosquito23 growth only, with only death, emergence and aging
import os
import sys
...
sys.stdout.write("Time for 1 evolve step = " + str((timeit.default_timer() - start) / 10.0) + "s\n")
