...
# Maud's suggestion: The approach taken by `Mozzie` serve a crucial role in formulating and validating evolutionary hypotheses that might be challenging to explore in laboratory environments due to the intricacies involved, often deemed burdensome or costly. `Mozzie` allows sophisticated treatment of the evolution of the population, including competition and breeding between species, and spatio-temporal diffusion and advection of the populations.
